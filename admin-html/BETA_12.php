...
<html class="no-js">
    ...
    <![endif]-->
                                    ...
                                    <div class="panel-body pt0 pb0">
                                        <form class="form-horizontal group-border stripped" role="form" action="BETA_3.php" method="post">
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-12">
                                                    <select multiple="multiple" size="10" name="duallistbox[]" class="duallistbox">
